...
process = CrawlerProcess(get_project_settings())
process.crawl(GuangdongDrugSpider, recrawl_ids="{recrawl_ids_str}")
process.start()
'''
        ]
...
process = CrawlerProcess(get_project_settings())
process.crawl(HainanDrugSpider, recrawl_ids="{recrawl_ids_str}")
process.start()
'''
        ]
...
process = CrawlerProcess(get_project_settings())
process.crawl(NingxiaDrugSpider, recrawl_ids="{recrawl_ids_str}")
process.start()
'''
        ]
...
process = CrawlerProcess(get_project_settings())
process.crawl(HebeiDrugSpider, recrawl_ids="{recrawl_ids_str}")
process.start()
'''
        ]
